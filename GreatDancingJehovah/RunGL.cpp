...
GLfloat       globalIllumination_01_LIGHT_POSITION_01[]                                             =  {  -0.068917, 3.9, -0.715183, 1};
  ...
  GLfloat     ambient_globalIllumination_01        =  6.41005;
...
//#########################################################################################################################################################       
    ...
    //=======================================================================================                                           
     if (keys['J'])                                                                                                                   
    {                                                                                                                                   
             goldenSunset_LIGHT_POSITION_01[0]         -=  0.0001;                                                                         
    }	                                                                                                                                  
    if (keys['L'])                                                                                                                      
    {	                                                                                                                                  
             goldenSunset_LIGHT_POSITION_01[0]         +=  0.0001;                                                                            
    ...
    if (keys['I'])                                                                                                                      
    {	                                                                                                                                  
             goldenSunset_LIGHT_POSITION_01[1]         +=  0.0001;                                                                            
    }	                                                                                                                                  
    if (keys['K'])                                                                                                                      
    {	                                                                                                                                  
             goldenSunset_LIGHT_POSITION_01[1]         -=  0.0001;                                                                            
    ...
    if (keys['O'])                                                                                                                      
    {	                                                                                                                                  
             goldenSunset_LIGHT_POSITION_01[2]        +=  0.01;                                                                            
    }	                                                                                                                                  
    if (keys['U'])                                                                                                                      
    {	                                                                                                                                  
             goldenSunset_LIGHT_POSITION_01[2]        -=  0.01;      
