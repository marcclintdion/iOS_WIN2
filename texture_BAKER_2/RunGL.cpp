...
//######################################################################################################################
                                ...
                                //------------------------
                                GLfloat     scalePerlin      =  64/(GLfloat)NOISE_3D_SIZE*1.0;  
                                //-----------------------
...
glBindBuffer(GL_FRAMEBUFFER, fboId_2D);
...
glViewport(0, 0, width, height);//-----set the viewport as the FBO won't be the same dimension as the screen
...
//It looks like all that is missing here is to bind an FBO to be read     
    ...
    FreeImage_Save(FIF_PNG, texture, "BBBBB.png", 0);         
