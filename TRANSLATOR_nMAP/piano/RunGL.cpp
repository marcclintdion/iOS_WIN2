...
//######################################################################################################################
                                ...
                                //====================================================================================                                          
                                GLfloat     pianoKey_C_POSITION[]              =  {  0.0, 0.0, 0.0, 1.0};                                                                    
                                //-----------------------------------------------------------------------
                                ...
                                //----------------------------------------------------------------------------                                                                       
                                GLfloat     pianoKey_C_LIGHT_POSITION_01[]     = { 21.45, 18.14, -51.2002, 1};
                                GLfloat     pianoKey_C_ATTENUATION             =    1.0;
                                GLfloat     pianoKey_C_SHININESS               =  113.33;                               
                                //----------------------------------------------------------------------------                                                                       
                                GLfloat     pianoKey_Black_LIGHT_POSITION_01[] = { 21.45, 18.14, -51.2002, 1};
                                GLfloat     pianoKey_Black_ATTENUATION         =    1.0;
                                GLfloat     pianoKey_Black_SHININESS           =  113.33;                                 
...
void ProcessKeyboard()					
{
    ...
    if (keys['J'])                                                                                                                   
    {                                                                                                                                   
             pianoKey_C_LIGHT_POSITION_01[0]         -=  .11;                                                                         
    }	                                                                                                                                  
    if (keys['L'])                                                                                                                      
    {	                                                                                                                                  
             pianoKey_C_LIGHT_POSITION_01[0]         +=  .11;                                                                            
    ...
    if (keys['I'])                                                                                                                      
    {	                                                                                                                                  
             pianoKey_C_LIGHT_POSITION_01[2]         +=  .11;                                                                            
    }	                                                                                                                                  
    if (keys['K'])                                                                                                                      
    {	                                                                                                                                  
             pianoKey_C_LIGHT_POSITION_01[2]         -=  .11;                                                                            
    ...
    if (keys['O'])                                                                                                                      
    {	                                                                                                                                  
             pianoKey_C_LIGHT_POSITION_01[1]         +=  .11;                                                                            
    }	                                                                                                                                  
    if (keys['U'])                                                                                                                      
    {	                                                                                                                                  
             pianoKey_C_LIGHT_POSITION_01[1]         -=  .11;                                                                            
