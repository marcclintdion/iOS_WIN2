	...
	{                                                                                                                                              
        ...
        outKeys << "  var     sculptris_LIGHT_POSITION_01[] = {" << sculptris_LIGHT_POSITION_01[0] << ", "                               
                                                                       << sculptris_LIGHT_POSITION_01[1] << ", "                               
                                                                       << sculptris_LIGHT_POSITION_01 [2] << ", " << 1.0 << "};\n";          
        outKeys << "  var     sculptris_ATTENUATION_01         =  " << sculptris_ATTENUATION_01   << ";\n";                                    
        outKeys << "  var     sculptris_SHININESS_01           =  " << sculptris_SHININESS_01  << ";\n";                                       
    }                                                                                                                                            
