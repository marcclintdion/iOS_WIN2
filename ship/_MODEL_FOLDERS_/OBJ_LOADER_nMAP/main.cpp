...
ofstream out_Globals("ship/ship_Globals.cpp");
         
         
         out_Globals << "GLuint      ship_SHADER_VERTEX;                                                                                                      "        << "\n";
         out_Globals << "GLuint      ship_SHADER_FRAGMENT;                                                                                                    "        << "\n";
         out_Globals << "GLuint      ship_SHADER;                                                                                                             "        << "\n";
         out_Globals << "//--------------------------------------                                                                                                  "        << "\n";
         out_Globals << "GLuint      UNIFORM_MODELVIEWPROJ_ship;                                                                                              "        << "\n";
         out_Globals << "GLuint      UNIFORM_LIGHT_MATRIX_ship;                                                                                               "        << "\n";
         out_Globals << "//--------------------------------------                                                                                                  "        << "\n";
         out_Globals << "GLuint      UNIFORM_LIGHT_POSITION_01_ship;                                                                                          "        << "\n";
         out_Globals << "GLuint      UNIFORM_SHININESS_ship;                                                                                                  "        << "\n";         
         out_Globals << "GLuint      UNIFORM_ATTENUATION_ship;                                                                                                  "        << "\n";           
         out_Globals << "GLuint      UNIFORM_TEXTURE_DOT3_ship;                                                                                               "        << "\n";
         out_Globals << "GLuint      UNIFORM_TEXTURE_ship;                                                                                                    "        << "\n";
         out_Globals << "//--------------------------------------                                                                                                  "        << "\n";

         out_Globals << "GLfloat     ship_POSITION[]            =  {  0.0, 0.0, 0.0, 1.0};                                                                    "        << "\n";
         out_Globals << "GLfloat     ship_ROTATE[]              =  {  0.0, 1.0,  0.0, 0.0};                                                                   "        << "\n";  
         out_Globals << "GLfloat     ship_SCALE[]               =  {  1.0, 1.0,  1.0, 1.0};                                                                   "        << "\n";          
         out_Globals << "//-----------------------------------------------------------------                                                                       "        << "\n";         
         out_Globals << "GLfloat     ship_LIGHT_POSITION_01[]   =  {  2.0, 15.0, 30.0, 1.0};                                                                  "        << "\n";           
         out_Globals << "GLfloat     ship_SHININESS             =    80.0;                                                                                    "        << "\n";   
         out_Globals << "GLfloat     ship_ATTENUATION           =     1.0;                                                                                    "        << "\n";         
         
         out_Globals << "//-----------------------------------------------------------------                                                                       "        << "\n";
         out_Globals << "GLuint      ship_VBO;                                                                                                                "        << "\n";             
         out_Globals << "//-----------------------------------------------------------------                                                                       "        << "\n";         
         out_Globals << "GLuint      ship_NORMALMAP;                                                                                                          "        << "\n";
         out_Globals << "GLuint      ship_TEXTUREMAP;                                                                                                         "        << "\n";


//====================================================================================================

ofstream out_Init("ship/ship_Init.cpp");
         ...
         out_Init << "      #endif                                                                                                                                    "        << "\n";
         out_Init << "      //===============================================================================================                                         "        << "\n";
         out_Init << "      ship_SHADER = glCreateProgram();                                                                                                         "        << "\n";
         out_Init << "      //---------------------------------------------------------------------                                                                   "        << "\n";
         out_Init << "      const GLchar *vertexSource_ship =                                                                                                        "        << "\n\n";
         ...
         out_Init << "      //---------------------------------------------------------------------                                                                   "        << "\n";
         out_Init << "      ship_SHADER_VERTEX = glCreateShader(GL_VERTEX_SHADER);                                                                                   "        << "\n";
         out_Init << "      glShaderSource(ship_SHADER_VERTEX, 1, &vertexSource_ship, NULL);                                                                        "        << "\n";
         out_Init << "      glCompileShader(ship_SHADER_VERTEX);                                                                                                     "        << "\n";
         
         out_Init << "      //---------------------------------------------------------------------                                                                   "        << "\n";
         out_Init << "      const GLchar *fragmentSource_ship =                                                                                                            "        << "\n\n";
         ...
         out_Init << "      \"    }\\n\";                                                                                                                                   "        << "\n\n";
         out_Init << "      //---------------------------------------------------------------------                                                                         "        << "\n";
         out_Init << "      ship_SHADER_FRAGMENT = glCreateShader(GL_FRAGMENT_SHADER);                                                                                     "        << "\n";
         out_Init << "      glShaderSource(ship_SHADER_FRAGMENT, 1, &fragmentSource_ship, NULL);                                                                          "        << "\n";
         out_Init << "      glCompileShader(ship_SHADER_FRAGMENT);                                                                                                         "        << "\n";
         out_Init << "      //------------------------------------------------                                                                                              "        << "\n";
         out_Init << "      glAttachShader(ship_SHADER, ship_SHADER_VERTEX);                                                                                              "        << "\n";
         out_Init << "      glAttachShader(ship_SHADER, ship_SHADER_FRAGMENT);                                                                                            "        << "\n";
         out_Init << "      //------------------------------------------------                                                                                              "        << "\n";
         out_Init << "      glBindAttribLocation(ship_SHADER, 0, \"position\");                                                                                            "        << "\n";
         out_Init << "      glBindAttribLocation(ship_SHADER, 1, \"texture\");                                                                                             "        << "\n";
         out_Init << "      //glBindAttribLocation(ship _SHADER, 2, \"normal\");                                                                                           "        << "\n";
         
         
         out_Init << "      //------------------------------------------------                                                                                              "        << "\n";
         out_Init << "      glLinkProgram(ship_SHADER);                                                                                                                    "        << "\n";
         out_Init << "      //------------------------------------------------                                                                                              "        << "\n";
         out_Init << "      #ifdef __APPLE__                                                                                                                                "        << "\n";
         out_Init << "      glDetachShader(ship_SHADER, ship_SHADER_VERTEX);                                                                                              "        << "\n";
         out_Init << "      glDetachShader(ship_SHADER, ship_SHADER_FRAGMENT);                                                                                            "        << "\n";
         out_Init << "      #endif                                                                                                                                          "        << "\n";
         out_Init << "      //------------------------------------------------                                                                                              "        << "\n";
         out_Init << "      glDeleteShader(ship_SHADER_VERTEX);                                                                                                            "        << "\n";
         out_Init << "      glDeleteShader(ship_SHADER_FRAGMENT);                                                                                                          "        << "\n";


         out_Init << "      //------------------------------------------------------------------------------------------------------------//___LOAD_UNIFORMS                "        << "\n";
         out_Init << "      UNIFORM_MODELVIEWPROJ_ship                   = glGetUniformLocation(ship_SHADER,   \"mvpMatrix\");                                              "        << "\n";
         out_Init << "      UNIFORM_LIGHT_MATRIX_ship                    = glGetUniformLocation(ship_SHADER,   \"lightMatrix\");                                            "        << "\n";
         out_Init << "      UNIFORM_LIGHT_POSITION_01_ship               = glGetUniformLocation(ship_SHADER,   \"light_POSITION_01\");                                      "        << "\n"; 
         out_Init << "      UNIFORM_SHININESS_ship                       = glGetUniformLocation(ship_SHADER,   \"shininess\");                                              "        << "\n";         
         out_Init << "      UNIFORM_ATTENUATION_ship                     = glGetUniformLocation(ship_SHADER,   \"attenuation\");                                              "        << "\n";          
         out_Init << "      UNIFORM_TEXTURE_DOT3_ship                    = glGetUniformLocation(ship_SHADER,   \"NormalMap\");                                              "        << "\n";        
         out_Init << "      UNIFORM_TEXTURE_ship                         = glGetUniformLocation(ship_SHADER,   \"Texture1\");                                               "        << "\n";
         out_Init << "      //------------------------------------------------------------------------------------------------------------//___LOAD_TEXTURES                "        << "\n";


         out_Init << "      //------------------------------------------------------------------------------------------                                              "        << "\n";
         out_Init << "      #ifdef __APPLE__                                                                                                                          "        << "\n";
         out_Init << "      filePathName = [[NSBundle mainBundle] pathForResource:@\"ship_DOT3\" ofType:@\"bmp\"];                                                  "        << "\n";
         out_Init << "      image = imgLoadImage([filePathName cStringUsingEncoding:NSASCIIStringEncoding], false);                                                   "        << "\n";
         out_Init << "      glGenTextures(1, &ship_NORMALMAP);                                                                                                     "        << "\n";
         out_Init << "      glBindTexture(GL_TEXTURE_2D, ship_NORMALMAP);                                                                                          "        << "\n";
         out_Init << "      ConfigureAndLoadTexture(image->data,  image->width, image->height );                                                                      "        << "\n";
         out_Init << "      imgDestroyImage(image);                                                                                                                   "        << "\n";
         out_Init << "      //---------------------                                                                                                                   "        << "\n";
         out_Init << "      filePathName = [[NSBundle mainBundle] pathForResource:@\"ship\" ofType:@\"png\"];                                                       "        << "\n";
         out_Init << "      image = imgLoadImage([filePathName cStringUsingEncoding:NSASCIIStringEncoding], false);                                                   "        << "\n";
         out_Init << "      glGenTextures(1, &ship_TEXTUREMAP);                                                                                                       "        << "\n";
         out_Init << "      glBindTexture(GL_TEXTURE_2D, ship_TEXTUREMAP);                                                                                            "        << "\n";
         out_Init << "      ConfigureAndLoadTexture(image->data,  image->width, image->height );                                                                      "        << "\n";
         out_Init << "      imgDestroyImage(image);                                                                                                                   "        << "\n";
         out_Init << "      #endif                                                                                                                                    "        << "\n";
         out_Init << "      //------------------------------------------------------------------------------------------                                              "        << "\n";
         out_Init << "      #ifdef WIN32                                                                                                                            "        << "\n";
         out_Init << "      loadTexture(\"_MODEL_FOLDERS_/ship/ship_DOT3.bmp\",          ship_NORMALMAP);                                                      "        << "\n";
         out_Init << "      loadTexture(\"_MODEL_FOLDERS_/ship/ship.png\",               ship_TEXTUREMAP);                                                        "        << "\n";
         out_Init << "      #endif                                                                                                                                    "        << "\n";
         out_Init << "      //------------------------------------------------------------------------------------------------------------//___LOAD_VBO               "        << "\n";
         out_Init << "      #include    \"ship.cpp\"                                                                                                                "        << "\n";
         out_Init << "      glGenBuffers(1,              &ship_VBO);                                                                                                "        << "\n";
         out_Init << "      glBindBuffer(GL_ARRAY_BUFFER, ship_VBO);                                                                                                "        << "\n";
         out_Init << "      glBufferData(GL_ARRAY_BUFFER, sizeof(ship), ship, GL_STATIC_DRAW);                                                                    "        << "\n";
...
ofstream out_Render("ship/ship_Render.cpp");

         
         out_Render << "    glUseProgram(ship_SHADER);                                                                                                                                              "        << "\n";
         out_Render << "    glBindBuffer(GL_ARRAY_BUFFER, ship_VBO);                                                                                                                                "        << "\n";
         out_Render << "    //---------------------------------------------------------------------------------------------------------------------------------------------------|__MODEL             "        << "\n";
         out_Render << "    LoadIdentity(modelView);                                                                                                                                                  "        << "\n";
         out_Render << "    Translate(modelView, ship_POSITION[0], ship_POSITION[1], ship_POSITION[2]);                                                                                               "        << "\n";
         out_Render << "    Rotate(modelView, ship_ROTATE[0], ship_ROTATE[1], ship_ROTATE[2], ship_ROTATE[3]);                                                                                        "        << "\n";
         out_Render << "    Scale(modelView, 0.5, 0.5, 0.5);                                                                                                                                          "        << "\n";         
         ...
         out_Render << "    glUniform4f(UNIFORM_LIGHT_POSITION_01_ship, ship_LIGHT_POSITION_01[0], ship_LIGHT_POSITION_01[1], ship_LIGHT_POSITION_01[2], ship_LIGHT_POSITION_01[3]);                  "        << "\n";
         out_Render << "    glUniform1f(UNIFORM_SHININESS_ship, ship_SHININESS);                                                                                                                      "        << "\n";         
         out_Render << "    glUniform1f(UNIFORM_ATTENUATION_ship, ship_ATTENUATION);                                                                                                                  "        << "\n";         
         out_Render << "    glUniformMatrix4fv(UNIFORM_MODELVIEWPROJ_ship,   1,0,  mvpMatrix);                                                                                                        "        << "\n";
         out_Render << "    glUniformMatrix4fv(UNIFORM_LIGHT_MATRIX_ship,    1,0,  lightMatrix);                                                                                                      "        << "\n";
         out_Render << "    //======================================================================================================                                                                  "        << "\n";         
         out_Render << "    glActiveTexture ( GL_TEXTURE1 );                                                                                                                                          "        << "\n";
         out_Render << "    glBindTexture(GL_TEXTURE_2D, ship_NORMALMAP);                                                                                                                             "        << "\n";
         out_Render << "    glUniform1i (UNIFORM_TEXTURE_DOT3_ship, 1);                                                                                                                               "        << "\n";
         out_Render << "    //---                                                                                                                                                                     "        << "\n";
         out_Render << "    glActiveTexture (GL_TEXTURE0);                                                                                                                                            "        << "\n";
         out_Render << "    glBindTexture(GL_TEXTURE_2D, ship_TEXTUREMAP);                                                                                                                            "        << "\n";  
         out_Render << "    glUniform1i (UNIFORM_TEXTURE_ship, 0 );                                                                                                                                   "        << "\n";
         out_Render << "    //---------------------------------------------------------------------------------------------------------------------------------------------------|__DRAW              "        << "\n";
...
ofstream out_Keyboard("ship/ship_Keyboard.cpp");

         out_Keyboard << "    //=======================================================================================                                           "        << "\n";
         out_Keyboard << "    /*if (keys['J'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {                                                                                                                                   "        << "\n";
         out_Keyboard << "             ship_POSITION[0]         -=  .01;                                                                                  "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         ...
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             ship_POSITION[1]         +=  .01;                                                                                  "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         ...
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             ship_POSITION[2]         +=  .01;                                                                                  "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         ...
         out_Keyboard << "     if (keys['J'])                                                                                                                   "        << "\n";
         out_Keyboard << "    {                                                                                                                                   "        << "\n";
         out_Keyboard << "             ship_LIGHT_POSITION_01[0]         -=  .11;                                                                         "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         out_Keyboard << "    if (keys['L'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             ship_LIGHT_POSITION_01[0]         +=  .11;                                                                            "        << "\n";
         ...
         out_Keyboard << "    if (keys['I'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             ship_LIGHT_POSITION_01[1]         +=  .11;                                                                            "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         out_Keyboard << "    if (keys['K'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             ship_LIGHT_POSITION_01[1]         -=  .11;                                                                            "        << "\n";
         ...
         out_Keyboard << "    if (keys['O'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             ship_LIGHT_POSITION_01[2]         +=  .11;                                                                            "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         out_Keyboard << "    if (keys['U'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             ship_LIGHT_POSITION_01[2]         -=  .11;                                                                            "        << "\n";
         ...
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             ship_ATTENUATION                  +=  .01;                                                                            "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         ...
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             ship_SHININESS                  +=  1.01;                                                                            "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         ...
         out_Keyboard << "	{                                                                                                                                              "        << "\n";
         out_Keyboard << "        ofstream outKeys(\"_MODEL_FOLDERS_/ship/ship_SHADER_SETTINGS.cpp\");                                                                                     "        << "\n";
        
        
         out_Keyboard << "        outKeys << \"  GLfloat     ship_LIGHT_POSITION_01[] = {\" << ship_LIGHT_POSITION_01[0] << \", \"                               "        << "\n";
         out_Keyboard << "                                                                       << ship_LIGHT_POSITION_01[1] << \", \"                               "        << "\n";
         out_Keyboard << "                                                                       << ship_LIGHT_POSITION_01 [2] << \", \" << 1.0 << \"};\\n\";          "        << "\n";
        
         out_Keyboard << "        outKeys << \"  GLfloat     ship_ATTENUATION         =  \" << ship_ATTENUATION   << \";\\n\";                                    "        << "\n";
        
         out_Keyboard << "        outKeys << \"  GLfloat     ship_SHININESS           =  \" << ship_SHININESS  << \";\\n\";                                       "        << "\n";
...
ofstream out_ShutDown("ship/ship_Shutdown.cpp");
//--------------------------------------------------------


         out_ShutDown << "                    if(ship_NORMALMAP != 0)                                                                                        "        << "\n"; 
         out_ShutDown << "                    {                                                                                                              "        << "\n"; 
         out_ShutDown << "                            glDeleteTextures(1, &ship_NORMALMAP);                                                                  "        << "\n"; 
         out_ShutDown << "                            ship_NORMALMAP = 0;                                                                                    "        << "\n"; 
         out_ShutDown << "                    }                                                                                                              "        << "\n"; 
         out_ShutDown << "                    if(ship_TEXTUREMAP  != 0)                                                                                      "        << "\n"; 
         out_ShutDown << "                    {                                                                                                              "        << "\n"; 
         out_ShutDown << "                            glDeleteTextures(1, &ship_TEXTUREMAP);                                                                 "        << "\n"; 
         out_ShutDown << "                            ship_TEXTUREMAP  = 0;                                                                                  "        << "\n"; 
         out_ShutDown << "                    }                                                                                                              "        << "\n"; 
         out_ShutDown << "                    if(ship_VBO  != 0)                                                                                             "        << "\n"; 
         out_ShutDown << "                    {                                                                                                              "        << "\n"; 
         out_ShutDown << "                            glDeleteBuffers(1, &ship_VBO);                                                                         "        << "\n"; 
         out_ShutDown << "                            ship_VBO  = 0;                                                                                         "        << "\n"; 
         out_ShutDown << "                    }                                                                                                              "        << "\n"; 


//====================================================================================================

ofstream out_LOCATION_STRINGS("ship/_LOCATION_STRINGS.cpp");
         
         out_LOCATION_STRINGS << "//====================================================================================                                          "        <<"\n";           
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/ship/ship_Globals.cpp\"                                                                "        <<"\n";                                              
         out_LOCATION_STRINGS << "//====================================================================================                                          "        <<"\n";           
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/ship/ship_Init.cpp\"                                                                   "        <<"\n";          
         out_LOCATION_STRINGS << "//====================================================================================                                          "        <<"\n";           
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/ship/ship_Shadow_01.cpp\"                                                              "        <<"\n";         
         out_LOCATION_STRINGS << "//====================================================================================                                          "        <<"\n";                  
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/ship/ship_Shadow_00.cpp\"                                                              "        <<"\n";           
         out_LOCATION_STRINGS << "//====================================================================================                                          "        <<"\n";                    
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/ship/ship_Render.cpp\"                                                                 "        <<"\n";
         out_LOCATION_STRINGS << "//====================================================================================                                          "        <<"\n";                    
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/ship/ship_Keyboard.cpp\"                                                               "        <<"\n";         
         out_LOCATION_STRINGS << "//====================================================================================                                          "        <<"\n";                  
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/ship/ship_Shutdown.cpp\"                                                               "        <<"\n";    
         out_LOCATION_STRINGS << "//====================================================================================                                          "        <<"\n";       
...
void display(void)
{
   ...
   ofstream out("ship/ship.cpp", ios::binary);
   
   ofstream outTEX("ship/ship_TEX.cpp", ios::binary);   
