...
ofstream out_Globals("sphere/sphere_Globals.cpp");
         ...
         out_Globals << "GLuint      UNIFORM_ATTENUATION_sphere;                                                                                                  "        << "\n";           
         ...
         out_Globals << "GLfloat     sphere_ATTENUATION           =     1.0;                                                                                    "        << "\n";         
         
         out_Globals << "//-----------------------------------------------------------------                                                                       "        << "\n";
         out_Globals << "GLuint      sphere_VBO;                                                                                                                "        << "\n";             
         out_Globals << "//-----------------------------------------------------------------                                                                       "        << "\n";         
         out_Globals << "GLuint      sphere_NORMALMAP;                                                                                                          "        << "\n";
         out_Globals << "GLuint      sphere_TEXTUREMAP;                                                                                                         "        << "\n";
...
ofstream out_Init("sphere/sphere_Init.cpp");
         ...
         out_Init << "      UNIFORM_ATTENUATION_sphere                     = glGetUniformLocation(sphere_SHADER,   \"attenuation\");                                              "        << "\n";          
         ...
         out_Init << "      glGenTextures(1, &sphere_NORMALMAP);                                                                                                     "        << "\n";
         out_Init << "      glBindTexture(GL_TEXTURE_2D, sphere_NORMALMAP);                                                                                          "        << "\n";
         ...
         out_Init << "      image = imgLoadImage([filePathName cStringUsingEncoding:NSASCIIStringEncoding]);                                                   "        << "\n";
         out_Init << "      glGenTextures(1, &sphere_TEXTUREMAP);                                                                                                       "        << "\n";
         out_Init << "      glBindTexture(GL_TEXTURE_2D, sphere_TEXTUREMAP);                                                                                            "        << "\n";
         out_Init << "      ConfigureAndLoadTexture(image->data,  image->width, image->height );                                                                      "        << "\n";
         out_Init << "      imgDestroyImage(image);                                                                                                                   "        << "\n";
         out_Init << "      #endif                                                                                                                                    "        << "\n";
         out_Init << "      //------------------------------------------------------------------------------------------                                              "        << "\n";
         out_Init << "      #ifdef WIN32                                                                                                                            "        << "\n";
         out_Init << "      loadTexture(\"_MODEL_FOLDERS_/sphere/sphere_DOT3.bmp\",          sphere_NORMALMAP);                                                      "        << "\n";
         out_Init << "      loadTexture(\"_MODEL_FOLDERS_/sphere/sphere.png\",               sphere_TEXTUREMAP);                                                        "        << "\n";
         out_Init << "      #endif                                                                                                                                    "        << "\n";
...
ofstream out_Render("sphere/sphere_Render.cpp");
         ...
         out_Render << "    glUniform1f(UNIFORM_ATTENUATION_sphere, sphere_ATTENUATION);                                                                                                                  "        << "\n";         
         ...
         out_Render << "    glBindTexture(GL_TEXTURE_2D, sphere_NORMALMAP);                                                                                                                          "        << "\n";
         out_Render << "    glUniform1i (UNIFORM_TEXTURE_DOT3_sphere, 1);                                                                                                                             "        << "\n";
         out_Render << "    //---                                                                                                                                                                     "        << "\n";
         out_Render << "    glActiveTexture (GL_TEXTURE0);                                                                                                                                            "        << "\n";
         out_Render << "    glBindTexture(GL_TEXTURE_2D, sphere_TEXTUREMAP);                                                                                                                            "        << "\n";  
...
ofstream out_Keyboard("sphere/sphere_Keyboard.cpp");
         ...
         out_Keyboard << "     if (keys['J'])                                                                                                                   "        << "\n";
         out_Keyboard << "    {                                                                                                                                   "        << "\n";
         out_Keyboard << "             sphere_LIGHT_POSITION_01[0]         -=  .11;                                                                         "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         out_Keyboard << "    if (keys['L'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             sphere_LIGHT_POSITION_01[0]         +=  .11;                                                                            "        << "\n";
         ...
         out_Keyboard << "    if (keys['I'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             sphere_LIGHT_POSITION_01[1]         +=  .11;                                                                            "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         out_Keyboard << "    if (keys['K'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             sphere_LIGHT_POSITION_01[1]         -=  .11;                                                                            "        << "\n";
         ...
         out_Keyboard << "    if (keys['O'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             sphere_LIGHT_POSITION_01[2]         +=  .11;                                                                            "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         out_Keyboard << "    if (keys['U'])                                                                                                                      "        << "\n";
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             sphere_LIGHT_POSITION_01[2]         -=  .11;                                                                            "        << "\n";
         ...
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             sphere_ATTENUATION                  +=  .01;                                                                            "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         ...
         out_Keyboard << "    {	                                                                                                                                  "        << "\n";
         out_Keyboard << "             sphere_SHININESS                  +=  1.01;                                                                            "        << "\n";
         out_Keyboard << "    }	                                                                                                                                  "        << "\n";
         ...
         out_Keyboard << "	{                                                                                                                                              "        << "\n";
         out_Keyboard << "        ofstream outKeys(\"_MODEL_FOLDERS_/sphere/sphere_SHADER_SETTINGS.cpp\");                                                                                     "        << "\n";
        
        
         out_Keyboard << "        outKeys << \"  GLfloat     sphere_LIGHT_POSITION_01[] = {\" << sphere_LIGHT_POSITION_01[0] << \", \"                               "        << "\n";
         out_Keyboard << "                                                                       << sphere_LIGHT_POSITION_01[1] << \", \"                               "        << "\n";
         out_Keyboard << "                                                                       << sphere_LIGHT_POSITION_01 [2] << \", \" << 1.0 << \"};\\n\";          "        << "\n";
        
         out_Keyboard << "        outKeys << \"  GLfloat     sphere_ATTENUATION         =  \" << sphere_ATTENUATION   << \";\\n\";                                    "        << "\n";
        
         out_Keyboard << "        outKeys << \"  GLfloat     sphere_SHININESS           =  \" << sphere_SHININESS  << \";\\n\";                                       "        << "\n";
...
void display(void)
{
   ...
   ofstream outTEX("sphere/sphere_TEX.cpp", ios::binary);   
