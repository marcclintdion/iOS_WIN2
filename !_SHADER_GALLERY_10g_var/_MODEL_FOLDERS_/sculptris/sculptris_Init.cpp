...
"         color                 =  texture2D(Texture1, varTexcoord.st, 0.0) ;                                                              \n"//vec4(0.9, 0.6, 0.6, 1.0) 

"         Reflect               =  reflect(invertView, normal);                                                                                                 \n"

"         RH                    =  normalize(Reflect + invertView);                                                                                             \n"

"         color_B               =  texture2D(Texture1, varTexcoord.st) * pow(NdotL1, shininess_01) * vec4(1.0, 1.0, 0.1, 1.0)*.5;                                  \n"   

"         gl_FragColor          =   (color + color_B + pow(NdotL1, shininess_01 * 2.0)*NdotL1 *NdotL1 * attenuation_01 + pow(NdotL1,  700.0))*.5;                                                   \n"
