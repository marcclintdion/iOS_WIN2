...
//____%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%           
			      ...
			      { 
                          marcWalking = true;                     
                          eyePosition[1]                     -= YZ_axisMoveUPDOWN_Sin   * frameRateAdjustment;
                          eyePosition[2]                     += YZ_axisMoveUPDOWN_Cos   * frameRateAdjustment;
                          
                          marcModelPosition[1]               += 0.00000                 * frameRateAdjustment;                          
                          marcModelPosition[2]               -= 0.01965                 * frameRateAdjustment;                          
...
//____%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%            
			      ...
			      {              
                                 marcWalking = true;                    
                                 eyePosition[0]                -=  0.014                   *   frameRateAdjustment;
                                 eyePosition[1]                +=  YZ_axisMoveDIAGONAL_Sin  *   frameRateAdjustment;                                
                                 eyePosition[2]                -=  YZ_axisMoveDIAGONAL_Cos  *   frameRateAdjustment;
                                 
                                 marcModelPosition[0]          +=  0.014                   *   frameRateAdjustment;                                  
                                 marcModelPosition[1]          +=  0.000                   *   frameRateAdjustment;                          
                                 marcModelPosition[2]          +=  0.014                   *   frameRateAdjustment;                                   
