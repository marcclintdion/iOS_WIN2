    ...
    if (keys[VK_F8]) 			                                                                                                                   
	{                                                                                                                                              
        ofstream outKeys("_MODEL_FOLDERS_/backRightLowerLeg/backRightLowerLeg_SHADER_SETTINGS.cpp");                                                                                     
        outKeys << "  GLfloat     backRightLowerLeg_LIGHT_POSITION_01[] = {" << backRightLowerLeg_LIGHT_POSITION_01[0] << ", "                               
                                                                       << backRightLowerLeg_LIGHT_POSITION_01[1] << ", "                               
                                                                       << backRightLowerLeg_LIGHT_POSITION_01 [2] << ", " << 1.0 << "};\n";          
