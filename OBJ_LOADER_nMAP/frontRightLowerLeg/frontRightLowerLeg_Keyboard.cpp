    ...
    if (keys[VK_F8]) 			                                                                                                                   
	{                                                                                                                                              
        ofstream outKeys("_MODEL_FOLDERS_/frontRightLowerLeg/frontRightLowerLeg_SHADER_SETTINGS.cpp");                                                                                     
        outKeys << "  GLfloat     frontRightLowerLeg_LIGHT_POSITION_01[] = {" << frontRightLowerLeg_LIGHT_POSITION_01[0] << ", "                               
                                                                       << frontRightLowerLeg_LIGHT_POSITION_01[1] << ", "                               
                                                                       << frontRightLowerLeg_LIGHT_POSITION_01 [2] << ", " << 1.0 << "};\n";          
