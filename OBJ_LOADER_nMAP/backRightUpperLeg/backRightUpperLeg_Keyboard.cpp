    ...
    if (keys[VK_F8]) 			                                                                                                                   
	{                                                                                                                                              
        ofstream outKeys("_MODEL_FOLDERS_/backRightUpperLeg/backRightUpperLeg_SHADER_SETTINGS.cpp");                                                                                     
        outKeys << "  GLfloat     backRightUpperLeg_LIGHT_POSITION_01[] = {" << backRightUpperLeg_LIGHT_POSITION_01[0] << ", "                               
                                                                       << backRightUpperLeg_LIGHT_POSITION_01[1] << ", "                               
                                                                       << backRightUpperLeg_LIGHT_POSITION_01 [2] << ", " << 1.0 << "};\n";          
