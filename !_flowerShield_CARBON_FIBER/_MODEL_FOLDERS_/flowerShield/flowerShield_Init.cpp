...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      UNIFORM_MODELVIEW_flowerShield                       = glGetUniformLocation(flowerShield_SHADER,   "modelView");      
      ...
      UNIFORM_LIGHT_POSITION_02_flowerShield               = glGetUniformLocation(flowerShield_SHADER,   "light_POSITION_02");                                            
      UNIFORM_SHININESS_01_flowerShield                    = glGetUniformLocation(flowerShield_SHADER,   "shininess_01");                                              
      UNIFORM_SHININESS_02_flowerShield                    = glGetUniformLocation(flowerShield_SHADER,   "shininess_02");       
      UNIFORM_ATTENUATION_01_flowerShield                  = glGetUniformLocation(flowerShield_SHADER,   "attenuation_01");     
      UNIFORM_ATTENUATION_02_flowerShield                  = glGetUniformLocation(flowerShield_SHADER,   "attenuation_02");                                                    
      ...
      UNIFORM_FRESNELMAP_flowerShield                      = glGetUniformLocation(flowerShield_SHADER,   "FresnelMap");   
      UNIFORM_MASK_MAP_flowerShield                        = glGetUniformLocation(flowerShield_SHADER,   "MaskMap");   
      //------------------------------------------------------------------------------------------------------------//___LOAD_TEXTURES                
      #ifdef __APPLE__                                                                                                                          
      ...
      //------------------------------------------------------------------------------------------                                              
      #ifdef WIN32  
      loadTexture("_MODEL_FOLDERS_/flowerShield/SHEILD_MASK_11.png",                 flowerShield_MASK_MAP);       
